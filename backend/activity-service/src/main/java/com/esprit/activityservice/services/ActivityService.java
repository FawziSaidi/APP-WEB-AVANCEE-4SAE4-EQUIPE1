...
import com.esprit.activityservice.messaging.ActivityUserProducer;
...
public class ActivityService {
    ...
    private final ActivityUserProducer activityUserProducer;

    public ActivityService(ActivityRepository activityRepository,
                           EventClient eventClient,
                           ActivityUserProducer activityUserProducer) {
        this.activityRepository   = activityRepository;
        this.eventClient          = eventClient;
        this.activityUserProducer = activityUserProducer;
    }
    ...
    public ActivityResponseDTO addActivity(ActivityRequestDTO dto) {
        ...
        // ── Notification RabbitMQ → user-service ──────────────────────────
        activityUserProducer.notifyActivityCreated(
                saved.getIdActivity(),
                saved.getName(),
                saved.getEventId(),
                null  // userId récupéré par le user-service via eventId
        );
        // ──────────────────────────────────────────────────────────────────
    ...
    public ActivityResponseDTO updateActivity(Long id, ActivityRequestDTO dto) {
        ...
        // ── Notification RabbitMQ → user-service ──────────────────────────
        activityUserProducer.notifyActivityUpdated(
                updated.getIdActivity(),
                updated.getName(),
                updated.getEventId(),
                null
        );
    ...
    public void deleteActivity(Long id) {
        ...
        // ── Notification RabbitMQ → user-service ──────────────────────────
        activityUserProducer.notifyActivityDeleted(
