...
public class RabbitMQConfig {
    ...
    // ── Queues existantes : user-service ÉCOUTE ─────────────────────────────
    ...
    // ── NOUVELLES : user-service → lesson-service & cours-service ───────────
    public static final String USER_QUEUE_LESSON = "user.sync.queue.lesson";
    public static final String USER_QUEUE_COURS  = "user.sync.queue.cours";
    ...
    // ── Nouvelles queues ─────────────────────────────────────────────────────
    @Bean public Queue userQueueLesson() { return new Queue(USER_QUEUE_LESSON, true); }
    @Bean public Queue userQueueCours()  { return new Queue(USER_QUEUE_COURS,  true); }
