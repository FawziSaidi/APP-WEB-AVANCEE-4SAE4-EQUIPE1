 ...
 * Remplace les appels Feign à GET /users/{id} pour l'enrichissement
 * des publications avec les données de l'auteur.
 *
 * Doit avoir exactement les mêmes champs que UserEventDTO dans user-service.
 */
